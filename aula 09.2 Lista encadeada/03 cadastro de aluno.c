...
void add_alfabetica(No **head,char *nome,float nt,int ft){
    No *novo=malloc(sizeof(No));
    strcpy(novo->Login,nome);
    novo->nota=nt;
    novo->faltas=ft;
    ...
    else if(strcmp(nome,(*head)->Login)<0){
        novo->proximo=*head;
        *head=novo;
        return;
    }   
        ...
        while(aux->proximo!=NULL && strcmp(nome,aux->proximo->Login)>0){
            aux = aux->proximo;
        }
        ...
        //        while(aux!=NULL){
        //     //if(strcmp(nome,aux->proximo->Login)<0 && aux->proximo!=NULL)
        //     if(aux->proximo!=NULL && strcmp(nome,aux->proximo->Login)<0){
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                ...
                add_alfabetica(&celula, nome, nota, faltas);
